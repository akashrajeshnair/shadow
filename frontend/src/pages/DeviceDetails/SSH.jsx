...
const attackLogs = [
  { ip: "55.66.77.88", device: "SSH", timestamp: "2025-03-01 18:00", command: "Zero-Day Exploit" },
];
  ...
  return (
    <Container className="device-container">
      ...
      {Object.keys(attackDetails).length > 0 ? (
        ...
        <p className="no-attacks">No attacks recorded for SSH.</p>
      )}
    </Container>
  );
};
